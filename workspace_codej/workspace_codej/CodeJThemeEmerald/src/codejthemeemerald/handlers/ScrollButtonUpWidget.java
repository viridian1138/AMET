...
/**
 * The scroll-up button widget for the Emerald theme
 * 
 * @author tgreen
 *
 */
public class ScrollButtonUpWidget extends AbstractScrollbuttonWidget {
	...
	/**
	 * Prism for the upward-facing arrow of the button
	 */
	 ...
	 */
	private ScrollButtonUpWidget(GraphicsContext gc, ScrollbuttonWidgetInitializer lwi) {
		...
		double buttonMinHeight = MAX_HEIGHT - buttonHeight;

		double buttonCenterY = (MAX_HEIGHT + buttonMinHeight) / 2.0;
	...
	public static AbstractScrollbuttonWidget create(GraphicsContext gc, ScrollbuttonWidgetInitializer pwi) {
		...
		return (new ScrollButtonUpWidget(gc, pwi));
	}
		...
		if (changed) {
			if (in) {
...

				{
					...
					ArrayList<Vector3> ar = new ArrayList<Vector3>();
					ar.add(new Vector3(6.0 - prismHalf, buttonCenterY - prismHalf, 0.0 + prismHalf + buttonRaceWidth));
					ar.add(new Vector3(6.0 + prismHalf, buttonCenterY - prismHalf, 0.0 + prismHalf + buttonRaceWidth));
					ar.add(new Vector3(6.0, buttonCenterY + prismHalf, 0.0 + prismHalf + buttonRaceWidth));
