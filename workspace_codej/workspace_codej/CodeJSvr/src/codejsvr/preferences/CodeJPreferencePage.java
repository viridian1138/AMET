...
/**
 * Preferences page for the Code.J Server
 * 
 * @author tgreen
 *
 */
public class CodeJPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	public CodeJPreferencePage() {
		super(GRID);
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription("Code.J Web Server (Changes Take Effect Upon Server Restart)");
	}
