...
/**
 * Plug-in for a Metaverse Application testing prototype code
 * 
 * @author tgreen
 *
 */
public class PrototypeTestingApp extends MetaverseApplication {

	/**
	 * Default Constructor
	 */
	public PrototypeTestingApp() {
	}
	...
	public MetaverseApplicationInstance cresteInstance() {
		return (new PrototypeTestingAppInstance());
	}
