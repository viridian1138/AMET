...
/**
 * Plug-in for a meditation chamber Metaverse Application
 * 
 * @author tgreen
 *
 */
public class MeditationChamberApp extends MetaverseApplication {

	/**
	 * Default Constructor
	 */
	public MeditationChamberApp() {
	}
	...
	public MetaverseApplicationInstance cresteInstance() {
		return (new MeditationChamberAppInstance());
	}
