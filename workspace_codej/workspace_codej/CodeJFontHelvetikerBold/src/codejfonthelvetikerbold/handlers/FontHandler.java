...
/**
 * Class for instances of a web service for the Helvetiker bold font
 * 
 * @author tgreen
 *
 */
public class FontHandler implements HttpHandler {
	 ...
	 */
	public static final String FONT_PATH = "helvetiker_bold.typeface.json";
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			InputStream is = this.getClass().getResourceAsStream("helvetiker_bold.typeface.json");
