 ...
 * loading of the Helvetiker bold font
 * 
 * @author tgreen
 *
 */
public class FontResponseHandler implements HttpHandler {
	 ...
	 */
	public static final String HELVETIKER_BOLD_FONT = "HelvetikerBoldFont";

	/**
	 * The reference to the font in JS
	 */
	public static final String FONT_REFERENCE = "tmpObj.fontHelvetikerBold";
	...
	public static void handleFontLoading(SessionDataApplicationToken sess, GraphicsContext gc,
		...
		synchronized (syncObj) {
			SessionFontLoadingDesc desc = (SessionFontLoadingDesc) (std.objects.get(HELVETIKER_BOLD_FONT));
			if (desc == null) {
				desc = new SessionFontLoadingDesc();
				std.objects.put(HELVETIKER_BOLD_FONT, desc);
			}
