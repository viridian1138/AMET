...
/**
 * Class for instances of a web service to get a texture map for the Animated
 * Cubes application
 * 
 * @author tgreen
 *
 */
public class TextureMapHandler implements HttpHandler {
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			InputStream is = this.getClass().getResourceAsStream("183.jpg");
