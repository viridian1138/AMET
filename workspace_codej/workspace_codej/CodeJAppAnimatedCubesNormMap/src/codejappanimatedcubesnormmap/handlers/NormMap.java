 ...
 * for the Animated Cubes application
 * 
 * @author tgreen
 *
 */
public class NormMap implements INormMap {
	...
	public String getTextureMapReference() {
		return (CoreNames.TEXTURE_RESOURCE_PATH + "AnimatedCubes/plane.jpg");
	}

	@Override
	public String getNormReference() {
		return (CoreNames.TEXTURE_RESOURCE_PATH + "AnimatedCubes/plane_norm.jpg");
	}
