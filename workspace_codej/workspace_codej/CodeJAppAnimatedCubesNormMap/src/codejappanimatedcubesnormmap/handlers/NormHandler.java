...
/**
 * Class for instances of a web service to get a normal map for the Animated
 * Cubes application
 * 
 * @author tgreen
 *
 */
public class NormHandler implements HttpHandler {
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			InputStream is = this.getClass().getResourceAsStream("183_norm.jpg");
