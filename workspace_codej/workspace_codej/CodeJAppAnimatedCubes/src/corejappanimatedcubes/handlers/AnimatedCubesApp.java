...
/**
 * Plug-in for a Metaverse Application displaying a set of animated cubes
 * 
 * @author tgreen
 *
 */
public class AnimatedCubesApp extends MetaverseApplication {

	/**
	 * Default Constructor
	 */
	public AnimatedCubesApp() {
	}
	...
	public MetaverseApplicationInstance cresteInstance() {
		return (new AnimatedCubesAppInstance());
	}
