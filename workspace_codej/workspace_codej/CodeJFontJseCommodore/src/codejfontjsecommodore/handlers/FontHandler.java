...
/**
 * Class for instances of a web service for a Commodore font
 * 
...
public class FontHandler implements HttpHandler {
	 ...
	 */
	public static final String FONT_PATH = "jse_commodore.typeface.json";
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			InputStream is = this.getClass().getResourceAsStream("JSE_AmigaAMOS_Regular.json");
