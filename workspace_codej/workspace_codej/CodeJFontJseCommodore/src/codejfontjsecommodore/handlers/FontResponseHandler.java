...
package codejfontjsecommodore.handlers;
...
public class FontResponseHandler implements HttpHandler {
	 ...
	 */
	public static final String JSE_COMMODORE_FONT = "JseCommodoreFont";

	/**
	 * The reference to the font in JS
	 */
	public static final String FONT_REFERENCE = "tmpObj.fontJseCommodore";
	...
	public static void handleFontLoading(SessionDataApplicationToken sess, GraphicsContext gc,
		...
		synchronized (syncObj) {
			SessionFontLoadingDesc desc = (SessionFontLoadingDesc) (std.objects.get(JSE_COMMODORE_FONT));
			if (desc == null) {
				desc = new SessionFontLoadingDesc();
				std.objects.put(JSE_COMMODORE_FONT, desc);
			}
