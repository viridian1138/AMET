...
/**
 * Plug-in for a font viewer Metaverse Application
 * 
 * @author tgreen
 *
 */
public class FontViewerApp extends MetaverseApplication {

	/**
	 * Default Constructor
	 */
	public FontViewerApp() {
	}
	...
	public MetaverseApplicationInstance cresteInstance() {
		return (new FontViewerAppInstance());
	}
