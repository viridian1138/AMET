...
/**
 * Class for instances of a web service for the Kenney Pixel font
 * 
 * @author tgreen
 *
 */
public class FontHandler implements HttpHandler {
	 ...
	 */
	public static final String FONT_PATH = "kenney_pixel.typeface.json";
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			InputStream is = this.getClass().getResourceAsStream("Kenney_Pixel_Regular.json");
