...
package codejfontkenneypixel.handlers;
 ...
 * loading of the Kenney Pixel font
 * 
 * @author tgreen
 *
 */
public class FontResponseHandler implements HttpHandler {
	 ...
	 */
	public static final String KENNEY_PIXEL_FONT = "KenneyPixelFont";

	/**
	 * The reference to the font in JS
	 */
	public static final String FONT_REFERENCE = "tmpObj.fontKenneyPixel";
	...
	public static void handleFontLoading(SessionDataApplicationToken sess, GraphicsContext gc,
		...
		synchronized (syncObj) {
			SessionFontLoadingDesc desc = (SessionFontLoadingDesc) (std.objects.get(KENNEY_PIXEL_FONT));
			if (desc == null) {
				desc = new SessionFontLoadingDesc();
				std.objects.put(KENNEY_PIXEL_FONT, desc);
			}
