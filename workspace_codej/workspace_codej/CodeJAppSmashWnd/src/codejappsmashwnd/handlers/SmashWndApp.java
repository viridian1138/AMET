...
/**
 * Plug-in for a Metaverse Application with elements resembling Smash Box
 * 
 * @author tgreen
 *
 */
public class SmashWndApp extends MetaverseApplication {
	...
	public MetaverseApplicationInstance cresteInstance() {
		return (new SmashWndAppInstance());
	}
