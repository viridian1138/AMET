...
/**
 * A widget representing a rectangular box.
 * @author tgreen
 *
 */
public class BoxWidget extends Widget {
	...
	/**
	 * Whether audio has been defined for the box
	 */
	 ...
	 * @param gc The graphics context in which to display the box
	 * @param bwi Object used to initialize the box
	 */
	protected BoxWidget( String _geometryContext , String _meshContext , GraphicsContext gc , BoxWidgetInitializer bwi ) {
	...
	/**
	 * Creates an instance of the box widget
	 * @param gc The graphics context in which to display the box
	 * @param bwi Object used to initialize the box
	 * @return An instance of the box widget
	 */
	public static BoxWidget create( GraphicsContext gc , BoxWidgetInitializer bwi )
	{
		
		System.out.println( "Creating Box Widget" );
		...
		BoxWidget widget = new BoxWidget( geometryContext , meshContext , gc , bwi );
		
		
		Vector3 p = widget.getPosition();
		
		Vector3 l = bwi.getLength();
		
		
		gc.appendJs( "{\n" );
		gc.appendJs( geometryContext + " = new THREE.BoxGeometry(\n"
		    + "		" + l.getX() + ",\n"
			+ "		" + l.getY() + ",\n"
			+ "		" + l.getZ() + "\n"
			+ "	);\n"
