...
/**
 * Handler for an event that is delayed until a particular condition (such as an
...
public interface ICompletionHandler {
	...
	/**
	 * Dispatches a completion event to a handler
	 * 
	 * @param sess The session in which to dispatch the event
	 * @param gc   The graphics context in which to handle the event
	 */
