...
/**
 * Class for instances of a web service for the Kenney Future font
 * 
 * @author tgreen
 *
 */
public class FontHandler implements HttpHandler {
	 ...
	 */
	public static final String FONT_PATH = "kenney_future.typeface.json";
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			InputStream is = this.getClass().getResourceAsStream("Kenney_Future_Regular.json");
