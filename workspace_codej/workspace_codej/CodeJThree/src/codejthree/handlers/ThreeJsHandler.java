...
/**
 * Class for instances of a web service to get the JS definition for the
 * THREE.JS API
 * 
 * @author tgreen
 *
 */
public class ThreeJsHandler implements HttpHandler {
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			InputStream is = this.getClass().getResourceAsStream("three.module.js");
