...
/**
 * Class for instances of a web service to get the favicon icon
 * 
 * @author tgreen
 *
 */
public class FaviconHandler implements HttpHandler {
	...
	public void handle(HttpExchange t) throws IOException {
		...
		try {
			...
			String CONTENT_TYPE = "image/x-icon";
			...
			InputStream is = this.getClass().getResourceAsStream("favicon.ico");
